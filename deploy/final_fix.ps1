# Final Fix Script
Write-Host "Final Fix Script" -ForegroundColor Green
Write-Host "================" -ForegroundColor Green
Write-Host ""

# Fix MariaDB password
Write-Host "1. Fixing MariaDB password..." -ForegroundColor Cyan
ssh root@89.185.250.213 "mysql -e \"ALTER USER 'root'@'localhost' IDENTIFIED BY 'EJXTfBOG2t';\""

# Create database
Write-Host "2. Creating database..." -ForegroundColor Cyan
ssh root@89.185.250.213 "mysql -u root -pEJXTfBOG2t -e 'CREATE DATABASE IF NOT EXISTS earnings_table;'"

# Create user
Write-Host "3. Creating user..." -ForegroundColor Cyan
...
# Grant privileges
Write-Host "4. Granting privileges..." -ForegroundColor Cyan
...
ssh root@89.185.250.213 "cd /var/www/html/EarningsTable && ls -la sql/"
