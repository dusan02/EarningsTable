    ...
    if ($headers !== false) {
        ...
        if (strpos($status_line, '200') !== false) {
            ...
            if ($page_content !== false) {
                ...
                // Skontroluj, či obsahuje "Not Found" (FAILED TEST)
                if (strpos($page_content, 'Not Found') !== false) {
                    echo "   ❌ FAILED: Obsahuje 'Not Found' - stránka nefunguje!<br>\n";
                } else {
                    echo "   ✅ Neobsahuje 'Not Found'<br>\n";
